...
export default function RateListPage() {
  ...
  return (
    <div>
      <PageHeader title="Rate List" description="Manage service rates per location and financial year">
        ...
        <DialogContent className="max-w-lg">
          ...
          <div className="space-y-6 px-6 py-5">
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <Label htmlFor="rate-location" className="text-xs font-medium text-slate-600">
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="rate-sublocation" className="text-xs font-medium text-slate-600">
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="rate-service" className="text-xs font-medium text-slate-600">
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="rate-fy" className="text-xs font-medium text-slate-600">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <Label htmlFor="rate-value" className="text-xs font-medium text-slate-600">
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="rate-unit" className="text-xs font-medium text-slate-600">Unit</Label>
                  <Input
                    id="rate-unit"
                    value={form.unit}
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="rate-from" className="text-xs font-medium text-slate-600">
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="rate-to" className="text-xs font-medium text-slate-600">
